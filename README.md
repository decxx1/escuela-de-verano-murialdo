...
Sitio estático con Astro 5, React, Tailwind y PhotoSwipe. Los contenidos se obtienen del CMS headless Laravel durante el build; ya no se consulta la API deshabilitada de Strapi.
...
Frontend: [http://127.0.0.1:4321](http://127.0.0.1:4321). CMS: [http://127.0.0.1:8000/control](http://127.0.0.1:8000/control). No hace falta Docker. Bun 1.4.2 ejecuta Astro; Laravel se ejecuta con PHP/Artisan.
